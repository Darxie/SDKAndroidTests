...
abstract class BaseTest {
    ...
    private fun buildUATConfig(onlineMaps: Boolean): String {
        ...
        defaultConfig.online().routingUrl("https://directions.api.sygic.com")
        defaultConfig.online().sSOServerUrl("https://auth-testing.api.sygic.com")
        defaultConfig.online().productServer()
            .onlineMapsLinkUrl("https://licensing-testing.api.sygic.com")
        defaultConfig.online().searchUrl("https://search-testing.api.sygic.com")
        defaultConfig.online().incidents()
            .url("https://incidents-testing.api.sygic.com")
        defaultConfig.online().trafficUrl("https://traffic-testing.api.sygic.com")
        ...
        defaultConfig.online().placesUrl("https://places-testing.api.sygic.com")
